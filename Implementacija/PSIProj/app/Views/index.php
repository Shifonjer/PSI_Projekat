...
-->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 " src="<?php echo site_url('/img/slika3.jpg')?>" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo site_url('/img/slika2.jpg')?>" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="<?php echo site_url('/img/slika1.jpg')?>" alt="Third slide">
    </div>
  </div>
